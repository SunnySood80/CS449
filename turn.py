...
class Turn:
    ...
    def s(self):
        """
        Changes the choice to S
        """
        self.choice = S

    def o(self):
        """
        Changes the choice to O
        """
        self.choice = O

    def put(self):
        """
        Used to mark that the player has finished their turn
        """
        self.done = True
...
class AITurn(Turn):
    ...
    def __init__(self, num):
        """
        The constructor
        returns turn number in the game
        """
    ...
    def doPriorityMove(self):
        """
        finds the preferred move and if there are multiple, it chooses random
        Sorry for the copy/paste mess. This was the only way i could think to implement
        """
