...
class Game(GridLayout):
    ...
    """
    def __init__(self, root, player1='AI', player2='AI', darkmode=False, rows=9, cols=9):
        """
        The constructor
        ...
        rows: The number of the rows on the game board, default value to 9
        cols: The number of the cols on the game board, default value to 9
        """
    ...
    def on_s_pressed(self):
        """
        Changes the selection for the current turn to S, when the 's_btn' is pressed
        """
    ...
    def on_o_pressed(self):
        """
        Changes the selection for the current turn to O, when the 'o_btn' is pressed
        """
    ...
    def add_display_points(self):
        """
        Adds points if needed this is called after every turn
        """
